...
//Função Principal
int main() {
  //Inicializando máquina de números randômicos
    srand(time(NULL));
    op = 1;
  //Criando o primeiro nó da lista
...
//Executa a opção escolhida no menu
void menu_selecionar(int op){
    switch (op){
        case 1:
            lista_inserir(lista);
